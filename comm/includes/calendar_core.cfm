		...
		<cfloop index="kounter" from="1" to="#ArrayLen(DaysofWeek)#" step="1">
          ...
          <cfloop from="1" to="3" index="bloop">
            ...
            <cfif Evaluate(sec).maint eq true>
              <div class="maintenance"><a href="detail.cfm?lang=#lang#&amp;date=#taday###booking-#BRID#" class="maintenance" title="#taday# #language.maintenance#"><span style="display: none" rel="nofollow">#language.detailsFor# #language.maintenance# - #taday#</span> #language.maintenance#</a></div>
            <cfelseif vessel_name neq "">
            <div class="vessel #sec#"><a href="detail.cfm?lang=#lang#&amp;date=#taday###booking-#BRID#" class="confirmed" title="#taday# #vessel_name#" rel="nofollow"><span style="display: none">#language.detailsFor# #vessel_name# - #taday#</span> #vessel_name#</a><a class="legend" href="###sec#"><sup title="#legend[bloop]#"><span style="display: none">#bloop# - #legend[bloop]#</span>#bloop#</sup></a></div>
            </cfif>
          </cfloop>

          <cfif tent.num neq 0>
            <div><a href="detail.cfm?lang=#lang#&amp;date=#taday#" class="tentative" title="#taday# #tent.name#" rel="nofollow"><span style="display: none">#language.detailsFor# #tent.name# - #taday#</span> #tent.name#</a><a href="##tentative" class="legend tentative"><sup title="#legend[4]#"><span style="display: none">4 - #legend[4]#</span>4</sup></a></div>
          </cfif>

          <cfif pend.num neq 0>
            <div><a href="detail.cfm?lang=#lang#&amp;date=#taday#" class="pending" title="#taday# #pend.name#" rel="nofollow"><span style="display: none">#language.detailsFor# #pend.name# - #taday#</span> #pend.name#</a><a href="##pending" class="legend pending"><cfif sec3.name NEQ ""><sup title="#legend[5]#"><span style="display: none">5 - #legend[5]#</span>5</sup><cfelse><sup title="#legend[3]#"><span style="display: none">3 - #legend[3]#</span>3</sup></cfif></a></div>
          </cfif>
				</cfif>
			</td>
		</cfloop>
