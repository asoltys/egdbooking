...
<cfinclude template="#RootDir#includes/tete-header-#lang#.cfm">
		...
		<cfinclude template="#RootDir#includes/left-menu-gauche-#lang#.cfm">
			...
			<div class="center">
				...
				<table width="100%">
					<tr>
						<td align="left" width="23%"><a href="jetty3MonthCalendar.cfm?lang=#lang#&month=#prevmonth#&year=#prevyear#">#language.prev#</a></td>
						<td align="center">
						...
						<td align="right" width="23%"><a href="jetty3MonthCalendar.cfm?lang=#lang#&month=#nextmonth#&year=#nextyear#">#language.next#</a></td>
					</tr>
				</table>
				</cfoutput>
				...
				<table width="100%">
					<tr>
						<td align="left"><a href="jetty3MonthCalendar.cfm?lang=#lang#&month=#prevmonth#&year=#prevyear#">#language.prev#</a></td>
						<td align="right"><a href="jetty3MonthCalendar.cfm?lang=#lang#&month=#nextmonth#&year=#nextyear#">#language.next#</a></td>
					</tr>
				</table>
				</cfoutput>
