		...
		<cfinclude template="#RootDir#includes/left-menu-gauche-#lang#.cfm">
			...
			<div class="center">
				...
				<cfoutput>
					<table width="100%">
						<tr>
							<td align="left" width="23%"><a href="calend-cale-dock-3m.cfm?lang=#lang#&month=#prevmonth#&year=#prevyear#">#language.prev#</a></td>
							<td align="center">
								<form id="selection" name="selection" action="" style="margin: 0; padding:0; ">
									...
									<a href="javascript:go('calend-cale-dock-3m')" class="textbutton"><cfoutput>#language.Go#</cfoutput></a>
									</form>
								<CFINCLUDE template="#RootDir#includes/calendar_js.cfm">				</td>
							<td align="right" width="23%"><a href="calend-cale-dock-3m.cfm?lang=#lang#&month=#nextmonth#&year=#nextyear#">#language.next#</a></td>
						</tr>
					</table>
				</cfoutput>
				...
				<cfoutput>
					<table width="100%">
						<tr>
							<td align="left"><a href="calend-cale-dock-3m.cfm?lang=#lang#&month=#prevmonth#&year=#prevyear#">#language.prev#</a></td>
							<td align="right"><a href="calend-cale-dock-3m.cfm?lang=#lang#&month=#nextmonth#&year=#nextyear#">#language.next#</a></td>
						</tr>
					</table>
				</cfoutput>
