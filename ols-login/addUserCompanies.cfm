					...
					<cfif lang EQ 'e'><table align="center" width="85%"><cfelse><table align="center" width="100%"></cfif>
						...
						<cfif NOT isDefined("url.companies")>
							...
							<cfloop index = "ID" list = "#companyList#">
								...
								<tr>
									<td width="5%">
										<form action="removeUserCompany_confirm.cfm?lang=#lang#&companies=#companies#&info=#Variables.info#" method="post" id="remCompany#ID#">
					...
					<cfform action="addUserCompanies.cfm?lang=#lang#&companies=#companies#&info=#Variables.info#" name="addUserCompanyForm" method="post">
						...
						<tr>
							...
							<td>
								...
								<br />
								<font size="-2">#language.notListed# <a href="addCompany.cfm?lang=#lang#&info=#Variables.info#&companies=#companies#">#language.here#</a> #language.toCreate#</font>				</td>
						</tr>
						</table>
					</cfform>
