						...
						<table style="padding-left:20px; width:100%;" cellspacing="0">
							...
							<cfloop query="getDockBookings">
								...
								<tr class="#rowClass#">
									...
									<td style="width:25%;">
										<cfif status EQ "P" OR status eq "T"><div class="smallFont"><a href="#RootDir#reserve-book/tarifmod-tariffedit.cfm?lang=#lang#&amp;BookingID=#BookingID#" title="#language.editTariff#">#language.editTariff#</a></div>
										<cfelse><div class="smallFont"><a href="#RootDir#reserve-book/tarifconsult-tariffview.cfm?lang=#lang#&amp;BookingID=#BookingID#" title="#language.viewTariff#">#language.viewTariff#</a></div></cfif>
									</td>
								</tr>
