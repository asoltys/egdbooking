...
<cfset Variables.AdminEmail = DevEmail />
	...
	<cfmail to="#Variables.AdminEmail#" from="#getUser.email#" subject="Booking Cancellation Request" type="html" username="#mailuser#" password="#mailpassword#">
...
<cfset getUser.email = DevEmail />
	...
	<cfmail to="#getUser.email#" from="#Variables.AdminEmail#" subject="Booking Cancellation Request - Demande d'annulation de r&eacute;servation: #getBooking.VesselName#" type="html" username="#mailuser#" password="#mailpassword#">
