<cfcomponent output="yes">
	...
	<cffunction name="addBlock" access="public" output="no" returntype="boolean">
		...
		<cfelse>
			...
			<cfif Variables.BlockStructure.Width LTE DockSize.Width.Section3>
			...
			<cfelseif Variables.BlockStructure.Width LTE DockSize.Width.Section23>
				<cfset Variables.BlockStructure.Section1 = 0>
				<cfset Variables.BlockStructure.Section2 = 1>
				<cfset Variables.BlockStructure.Section3 = 1>
				<cfscript>ArrayAppend(Variables.TowerArray, Variables.BlockStructure);</cfscript>
			<cfelseif Variables.BlockStructure.Width LTE DockSize.Width.Section123>
	...
	<cffunction name="increment_section" access="private" output="no" returntype="struct">
		...
		<cfscript>
			...
			{
				if (Arguments.Width LTE DockSize.Width.Section12)
				{
			...
			{
				if (Arguments.Width LTE DockSize.Width.Section1)
				{
					ReturnStruct.Section1 = 1;
					ReturnStruct.Section2 = 0;
					ReturnStruct.Section3 = 0;
