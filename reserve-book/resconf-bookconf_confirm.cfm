		...
		<cfinclude template="#RootDir#includes/left-menu-gauche-#lang#.cfm">
			...
			<div class="center">
				...
				<div style="text-align:center;">
					<CFFORM action="#RootDir#reserve-book/resconf-bookconf_action.cfm?lang=#lang#$amp;CompanyID=#getBooking.CompanyID#$amp;referrer=#URLEncodedFormat(url.referrer)##variables.dateValue#$amp;jetty=#URL.jetty#" name="ConfirmBooking">
