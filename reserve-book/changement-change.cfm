...
<cfinclude template="#RootDir#includes/tete-header-#lang#.cfm">
		...
		<a href="#RootDir#formes-forms/changement-change-eng.pdf" title="Other Format - PDF">PDF Version (6KB)</a><br />
		<a class="help" href="http://www.tpsgc-pwgsc.gc.ca/comm/aformats-eng.html">Help on File Formats</a></div>
				...
				<li>Berthage @ NLW date(s): _____________________________</li>
				...
				<li>Berthage @ NLW amended date(s): _____________________________</li>
				<li>Remarks: _____________________________</li>
				</ol>
