 ...
 *
 * Example: <a href="index.html" onmouseover="return makeTrue(domTT_activate(this, event, 'caption', 'Help', 'content', 'This is a link with a tooltip', 'statusText', 'Link', 'trail', true));">click me</a>
 *
 * Options:
...
var domTT_screenEdgeDetection = false;
...
function domTT_show(in_id, in_event)
{
	...
	if (tooltip.get('position') == 'absolute')
	{
		...
		var coordinates;
		// don't need to check for edges.  Altered by Lois Chan, June 2005
		/**
