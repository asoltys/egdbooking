		...
		<cfinclude template="#RootDir#includes/left-menu-gauche-fra.cfm">
			...
			<div class="center">
				...
				<MAP name="aerial" id="aerial">
					...
					<AREA href="javascript:void(0);" alt="Vue a&eacute;rienne de la Cale sèche d'Esquimalt" title="Vue aérienne de la Cale sèche d'Esquimalt" shape="rect" coords="0,0,435,342">
				</MAP>
				<p>Afin de r&eacute;server une place pour un navire &agrave; l'une des installations de la Cale s&egrave;che d'Esquimalt, veuillez lancer <a href="#RootDir#reserve-book/booking.cfm?lang=fra">l'application des r&eacute;servations</a>.
				...
				<p><a href="#RootDir#reserve-book/booking.cfm?lang=fra">Application des r&eacute;servations</a> -
					Réserver la cale sèche et les jetées en ligne.</p>
				<p><a href="#RootDir#utils/bookingsSummary_choose.cfm?lang=fra">R&eacute;sum&eacute; des r&eacute;servations</a> - Voir toutes les réservations.</p>
				<p><i>Les liens suivants vous mèneront à des sites externes:</i><BR>
				(<img src="#RootDir#images/www1.gif" width="31" height="9" border="0" alt="emplacement de WWW" title="emplacement de WWW">)  <a href="http://lois.justice.gc.ca/fr/P-38.2/DORS-89-332/index.html">Règlement CSE</a></p>
				</cfoutput>
			</div>
