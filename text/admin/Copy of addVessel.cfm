...
<tr>
	<td id="LloydsID_Header"><label for="LloydsID">Lloyds ID:</label></td>
	<td headers="LloydsID_Header"><cfinput id="LloydsID" name="LloydsID" type="text" value="#variables.lloydsid#" size="20" maxlength="20"  CLASS="textField" message="Please enter the International Maritime Organization (I.M.O.) number."></td>
</tr>
<tr>
