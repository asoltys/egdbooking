...
<table width="100%">
	...
	<tr>
		...
		<td headers="Start">
			...
			<cfinput name="startDate" type="text" value="#DateFormat(startDate, 'mm/dd/yyyy')#" size="15" maxlength="10" required="yes" message="Please enter a start date." validate="date" class="textField" onChange="setLaterDate('self', 'editBookingForm', #Variables.bookingLen#)" onFocus="setEarlierDate('self', 'editBookingForm', #Variables.bookingLen#)"> <font class="light">#language.dateform#</font></CFOUTPUT>
	...
	<tr>
		...
		<td headers="Status">
			<cfif getBooking.Status EQ "C">
				...
				<div style="padding-left:74px;"><a href="javascript:EditSubmit('chgStatus_2t#BookingID#');" class="textbutton">Make Tentative</a></div>
				<DIV style="height:20;">&nbsp;</DIV>
			<cfelseif getBooking.Status EQ "T">
				Tentative
				&nbsp;&nbsp;&nbsp;<a href="javascript:EditSubmit('chgStatus_2p#BookingID#');" class="textbutton">Make Pending</a>
				<DIV style="height: 5px; ">&nbsp;</DIV>
				<div style="padding-left:67px;"><a href="javascript:EditSubmit('chgStatus_2c#BookingID#');" class="textbutton">Make Confirmed</a></div>
				<DIV style="height:20;">&nbsp;</DIV>
			<cfelse>
				Pending
				&nbsp;&nbsp;&nbsp;<a href="javascript:EditSubmit('chgStatus_2t#BookingID#');" class="textbutton">Make Tentative</a>
				<DIV style="height: 5px; ">&nbsp;</DIV>
				<div style="padding-left:63px;"><a href="javascript:EditSubmit('chgStatus_2c#BookingID#');" class="textbutton">Make Confirmed</a></div>
				<DIV style="height:20;">&nbsp;</DIV>
			</cfif>
		</td>
	</tr>
