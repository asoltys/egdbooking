...
<form action="bookingmanage.cfm?lang=#lang#" method="get" name="dateSelect">
	...
	<table align="center" style="width: 100%;">
		...
		<tr>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td align="right"><!--a href="javascript:validate('dateSelect');" class="textbutton">Submit</a--><input type="submit" class="textbutton" value="submit"></td>
		</tr>
	</table>
...
--->
	...
	<div style="font-weight: bold; font-style: italic; min-height:20px; ">Drydock <cfif #countPending.numPend# NEQ 0>(#countPending.numPend# #language.pending#)</cfif></div>
	</cfoutput>
	<table width="100%" cellspacing="0" cellpadding="0" style="padding-bottom: 5px; ">
		...
		<table style="font-size:10pt; padding-top:8px; padding-bottom:8px;" width="100%" cellspacing="0">
			<tr>
