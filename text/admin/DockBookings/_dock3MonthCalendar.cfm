...
<meta name=""keywords"" lang=""eng"" content=""Calendar, three month view, 3 month view, drydock side"">
<meta name=""description"" lang=""eng"" content=""Allows user to view all bookings in the drydock in a given three-month period."">
...
<div class="breadcrumbs"><a href="<cfoutput>http://www.pwgsc.gc.ca/text/home-#lang#.html</cfoutput>">PWGSC</a> &gt; Pacific Region &gt; <a href="http://www.pwgsc.gc.ca/pacific/egd/text/index-e.html">Esquimalt Graving Dock</a> &gt; <A href="booking.cfm?lang=#lang#">Booking</A> &gt; Drydock Calendar</div>
	...
	<table border="0">
		<tr>
		   ...
		   <td>
			...
			<td><a href ="javascript:go('dock3MonthCalendar')" class="textbutton">Go</a></td>
		</tr>
	</table>
</form>
...
<p>Click on a date to view booking information.</p>
...
<cfif GetEvents.RecordCount NEQ 0>

<cfelse>
	<h1 id="MonthDisplay"><cfoutput>#language.ScreenMessage#</cfoutput></h1>
</cfif>		
