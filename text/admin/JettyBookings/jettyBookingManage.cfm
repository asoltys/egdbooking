...
<form action="jettyBookingmanage.cfm?lang=<cfoutput>#lang#</cfoutput>" method="get" name="dateSelect">
	...
	<table align="center" style="width: 100%;">
		...
		<tr>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td align="right"><input type="submit" value="Submit" class="textbutton">
		</tr>
	</table>
	<br>
...
<cfloop index="jetty" from="1" to="2" step="1">	
	...
	<cfif getBookings.recordCount GT 0>
		...
		<cfif jetty EQ 1><div style="font-weight: bold; font-style: italic; min-height:20px; ">North Landing Wharf</div>
		<table style="padding-top:8px;padding-bottom:8px;font-size:10pt;" width="100%" cellspacing="0">
			<tr>
		...
		<cfelseif jetty EQ 2><div style="font-weight: bold; font-style: italic; min-height:20px; ">South Jetty</div>
		<table style="padding-top:8px; padding-bottom:8px;font-size:10pt;" width="100%" cellspacing="0">
			<tr>
				<td align="center"><b>Total:&nbsp;&nbsp;</b>
				<cfoutput>
	...
	<!--- This div broke formatting - Joao --->
	<!---</div>--->
							...
							<td headers="Confirmed">
									...
									<cfelse>
										...
										<CFIF getData.Status EQ "Y">
											<div style="padding-left:63px;"><a href="javascript:EditSubmit('deny#ID#');" class="textbutton">Deny Request</a></div>
										</CFIF>
										<div style="height: 20; ">&nbsp;</div>
									</cfif>
							</td>
