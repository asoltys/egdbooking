...
Calls to setEarlierDate and setLaterDate contains an incorrect form name (addJettyMaintBlock instead of
AddJettyMaintBlock), which causes a JavaScript error at runtime (frmObj has not properties).

Fix: Changed addJettyMaintBlock to AddJettyMaintBlock in lines 112 and 122 (shown here as lines 123 and 133)
--->
