...
<!---Check to see if jetty has already reached capacity (301m for both NLW and South Jetty)--->
<CFIF theBooking.NorthJetty>
	...
	<CFLOOP condition = "#tempDate# LESS THAN OR EQUAL TO #theBooking.EndDate#">
		...
		<CFIF (#checkLength.sumLength# NEQ "") AND (#checkLength.sumLength#+#theBooking.Length#) GT 301 AND NOT #error#>
			...
			<div class="waitList">
				<p>
				<strong>WARNING: Max Capacity (301m) Exceeded on #DateFormat(tempDate, "mmm d YYYY")#</strong><br />
