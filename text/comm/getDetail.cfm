		...
		<cfinclude template="#RootDir#includes/left-menu-gauche-#lang#.cfm">
			...
			<div class="center">
				...
				<CFIF NOT Anonymous OR EVALUATE(Variables.count) GT 0 OR (IsDefined('Session.AdminLoggedIn') AND Session.AdminLoggedIn eq true) OR Status eq 'c' >
					<div style="float: right; padding-right: 20px;"><a href="getBookingDetail.cfm?lang=#lang#&bookingid=#BookingID#&date=#url.date#&referrer=Details For">#language.moreInfo#</a></div>
				</cfif>
				<br>
				<br>
				</CFOUTPUT>
				...
				<CFIF NOT Anonymous OR #EVALUATE(Variables.count)# GT 0 OR (IsDefined('Session.AdminLoggedIn') AND Session.AdminLoggedIn eq true) OR Status eq 'c'><div style="float: right; padding-right: 20px;"><a href="getBookingDetail.cfm?lang=#lang#&bookingid=#BookingID#&date=#url.date#&referrer=Details For">#language.moreInfo#</a></div></cfif>
				<br>
				<br>
				</CFOUTPUT>
				<cfoutput>
