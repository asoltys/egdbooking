...
<cfform action="#Variables.action#" name="addUserForm" method="post">
	<table align="center" width="100%" style="padding-left:10px;">
		...
		<tr>
			...
			<td headers="password1_header"><cfinput type="password" name="password1" id="password1" required="yes" size="23" maxlength="10" class="textField" message="#language.password1Error#"><span style="font-size: 9pt;">(*6 - 10 #language.characters#)</span></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" align="center" style="padding-top:20px;">
				...
				<input type="button" value="#language.Cancel#" onClick="self.location.href='login.cfm?<cfoutput>lang=#lang#</cfoutput>'" class="textbutton">
			</td>
		</tr>
	</table>
</cfform>
