...
<cfif isDefined("session.form_structure")>
  ...
  <CFOUTPUT>
	...
	<CFELSE>
		...
		<a href="#RootDir#text/booking/editUser.cfm?lang=#lang#">#language.editProfile#</A> &gt;
		#language.CreateComp#
	</div>
	...
	<br><cfinclude template="#RootDir#includes/getStructure.cfm">

<br>
<cfform action="addCompany_action.cfm?lang=#lang#" name="addCompanyForm" method="post" onSubmit="if(!checkFilledIn('addCompanyForm')) { return false; }">
	<table align="center">
		<tr>
