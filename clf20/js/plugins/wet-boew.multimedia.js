/*!
 * Multimedia player v1.2 / Lecteur multim√©dia v1.2
...
var PlayerLib = {
	// Dictonary Terms
dictionary : {
play : (PE.language === 'eng') ? "Play " : "DÈmarrer ",
pause : "Pause ",
...
unmute: (PE.language === 'eng') ? "Unmute" : "DÈsactiver le mode muet",
...
audiodescription_on: (PE.language === 'eng') ? "Disable Audio Description " : "DÈsactiver l'audiodescription ",
...
"Votre navigateur ne semble pas avoir les capacitÈ nÈcessaires pour lire cette vidÈo, s'il vous plaÓt tÈlÈcharger la vidÈo ci-dessous",
position: (PE.language === 'eng') ? "Current Position: " : "Position actuelle : ",
duration: (PE.language === 'eng') ? "Total Time: " : "Temps total : ",
buffered: (PE.language === 'eng') ? "Buffered: " : "Mis en mÈmoire-tampon : "
},
...
$(document).ready( function(){
  ...
  // Default settings
  var config_settings = {
       flash  : { required : '10.1', data : Utils.getSupportPath() + '/multimedia/mp-jm.swf?c=' + Math.random() * 100000 },
