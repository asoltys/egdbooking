	...
	<div id="sidenav"> 			
		...
		<tr>
			<td>
				...
				<tr valign="middle">
					<td width="132" height="35" valign="top"><a href="http://www.pwgsc.gc.ca/pacific/egd/text/location-e.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('button1','','<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_location-e_on.gif',1)"><img name="button1" border="0" src="<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_location-e.gif" width="132" height="35" alt="Location" title="Location"></a></td>
				</tr>
				<tr valign="middle">
					<td width="132" height="35" valign="top"><a href="http://www.pwgsc.gc.ca/pacific/egd/text/services_main-e.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('button2','','<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_services-e_on.gif',1)"><img name="button2" border="0" src="<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_services-e.gif" width="132" height="35" alt="Services" title="Services"></a></td>
				</tr>
				<tr valign="middle">
					<td width="132" height="35" valign="top"><a href="http://www.pwgsc.gc.ca/pacific/egd/text/conduct-e.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('button10','','<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_codeofconduct-e_on.gif',1)"><img name="button10" border="0" src="<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_codeofconduct-e.gif" width="132" height="35" alt="Code of Conduct" title="Code of Conduct"></a></td>
				</tr>
				<tr valign="middle">
					<td width="132" height="35" valign="top"><a href="http://www.pwgsc.gc.ca/pacific/egd/text/shiprepairfirms-e.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('button3','','<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_shiprepairfirms-e_on.gif',1)"><img name="button3" border="0" src="<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_shiprepairfirms-e.gif" width="132" height="35" alt="Ship Repair Firms" title="Ship Repair Firms"></a></td>
				</tr>
				<tr valign="middle">
					<td width="132" height="35" valign="top"><a href="http://www.pwgsc.gc.ca/pacific/egd/text/environment-e.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('button4','','<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_environment-e_on.gif',1)"><img name="button4" border="0" src="<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_environment-e.gif" width="132" height="35" alt="Environment" title="Environment"></a></td>
				</tr>
 				<tr valign="middle">
					<td width="132" height="35" valign="top"><a href="http://www.pwgsc.gc.ca/pacific/egd/text/dockdimensions-e.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('button5','','<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_dockdimensions-e_on.gif',1)"><img name="button5" border="0" src="<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_dockdimensions-e.gif" width="132" height="35" alt="Dock Dimensions" title="Dock Dimensions"></a></td>
				</tr>
				<tr valign="middle">
					<td width="132" height="35" valign="top"><a href="http://www.pwgsc.gc.ca/pacific/egd/text/victoria-e.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('button6','','<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_victoria-e_on.gif',1)"><img name="button6" border="0" src="<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_victoria-e.gif" width="132" height="35" alt="Victoria" title="Victoria"></a></td>
				</tr>
				<tr valign="middle">
					<td width="132" height="35" valign="top"><a href="http://www.pwgsc.gc.ca/pacific/egd/text/history-e.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('button7','','<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_history-e_on.gif',1)"><img name="button7" border="0" src="<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_history-e.gif" width="132" height="35" alt="History" title="History"></a></td>
				</tr>
				<tr valign="middle">
				...
				<tr valign="middle">
					<td height="29" width="132"><a href="http://www.pwgsc.gc.ca/pacific/egd/text/performance-e.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('button11','','<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_performance-e_on.gif',1)"><img name="button11" border="0" src="<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_performance-e.gif" width="132" height="35" alt="Performance Standards" title="Performance Standards"></a></td>
				</tr>
				<tr valign="middle">
					<td width="132" height="35" valign="top"><a href="http://www.pwgsc.gc.ca/pacific/egd/text/contact_us-e.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('button9','','<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_contactus-e_on.gif',1)"><img name="button9" border="0" src="<cfoutput>#RootDir#</cfoutput>images/sidenav_images/button_contactus-e.gif" width="132" height="35" alt="Contact Us" title="Contact Us"></a></td>
				</tr>
				</table>
			</td>
		</tr>
