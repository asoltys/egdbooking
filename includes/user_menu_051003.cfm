...
ATTEMPT TO FIX LINK TO USER DOCUMENTATION (HELP) IN USER MENU

Currently, the hyperlink points to /text/egd_userdoc-#lang#.html, but the
actual location of the documentation is in /text/booking

Fix: Changed href attribute of Help link in line 58 (shown as line 69 here)
--->
