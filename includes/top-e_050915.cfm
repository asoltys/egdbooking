...
<table width="600" border="0" cellspacing="0" cellpadding="0">
  <tr align="left" valign="top"> 
    ...
    <td width="90" align="left" valign="top"><a href="<cfoutput>#RootDir#</cfoutput>text/contact_us-e.cfm"><img src="<cfoutput>#RootDir#</cfoutput>images/nav1st_level_contact-e.gif" width="90" height="14" vspace="0" hspace="0" border="0" alt="Contact Us"></a></td>
    ...
    <td width="90" align="left" valign="top"><a href="<cfoutput>#RootDir#</cfoutput>text/search-e.cfm"><img src="<cfoutput>#RootDir#</cfoutput>images/nav1st_level_search-e.gif" width="90" height="14" vspace="0" hspace="0" border="0" alt="Search"></a></td>
