...
<table width="600" border="0" cellspacing="0" cellpadding="0">
  <tr align="left" valign="top"> 
    ...
    <td width="90" align="left" valign="top"><a href="http://www.pwgsc.gc.ca/pacific/egd/text/help-e.html"><img src="<cfoutput>#RootDir#</cfoutput>images/nav1st_level_help-e.gif" width="90" height="14" vspace="0" hspace="0" border="0" alt="Help"></a></td>
...
<cfinclude template="#RootDir#includes/corpnav/corp-nav-e.html">
...
<table width="600" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="http://www.pwgsc.gc.ca/pacific/egd/text/new-e.html"><img name="Image7" border="0" src="<cfoutput>#RootDir#</cfoutput>images/whats-e.gif" width="89" height="14" alt="What's New"></a></td>
    <td><img src="<cfoutput>#RootDir#</cfoutput>images/spacer.gif" width="1" height="14" alt=""></td>
    <td><a href="http://www.pwgsc.gc.ca/pacific/egd/text/site-e.html"><img name="Image8" border="0" src="<cfoutput>#RootDir#</cfoutput>images/map-e.gif" width="89" height="14" alt="Branch Site Map"></a></td>
    <td><img src="<cfoutput>#RootDir#</cfoutput>images/spacer.gif" width="1" height="14" alt=""></td>
    <td><a href="http://www.pwgsc.gc.ca/pacific/egd/text/index-e.html"><img name="Image9" border="0" src="<cfoutput>#RootDir#</cfoutput>images/home_sample-e.gif" width="89" height="14" alt="Branch Home"></a></td>
  </tr>
</table>
</div>
