...
1. ATTEMPT TO FIX JAVASCRIPT ERROR
...
Fix: Changed single quotes to double quotes in line 32 (shown here as line 51)

2. ATTEMPT TO FILL IN MISSING VALUE

The definition for language.warning (french version) is missing

Fix: Copied the value assigned to the same variable in dock_calendar_menu.cfm into line 8 (shown here as line 27)
--->
