...
<p>Afin de r&eacute;server une place pour un navire &agrave; l'une des installations de la Cale s&egrave;che d'Esquimalt, veuillez lancer <a href="<cfoutput>#RootDir#</cfoutput>text/reserve-book/booking.cfm?lang=f">l'application des r&eacute;servations</a>.
...
<p><a href="<cfoutput>#RootDir#</cfoutput>text/reserve-book/booking.cfm?lang=f">Application des réservations</a> - Réserver la cale sèche et les jetées en ligne.</p>
