...
<cfoutput>
<cfform action="addCompany_action.cfm?lang=#lang#$amp;info=#url.info#$amp;companies=#url.companies#" name="addCompanyForm" method="post" onsubmit="if(!checkFilledIn('addCompanyForm')) { return false;
	}">
	<table align="center">
		<tr>
			<td id="companyName"><label for="name">Name:</label></td>
			<td headers="companyName"><cfinput name="name" value="#variables.name#" id="name" type="text" size="40" maxlength="75" required="yes" CLASS="textField" message="#language.nameError#" /></td>
		</tr>
		<tr>
			<td id="abbr_Header"><label for="abbrev">Abbreviation:</label></td>
			<td headers="abbr_Header"><cfinput name="abbrev" id="abbrev" type="text" size="10" maxlength="3" value="#variables.abbrev#" required="yes" CLASS="textField" message="#language.abbrevError#" /></td>
		</tr>
		<tr>
			<td id="address1_header"><label for="address1">Address 1:</label></td>
			<td headers="address1_header"><cfinput name="address1" value="#variables.address1#" id="address1" type="text" size="40" maxlength="75" required="yes" CLASS="textField" message="#language.addressError#" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td headers="city_header"><cfinput name="city" value="#variables.city#" id="city" type="text" size="25" maxlength="40" required="yes" CLASS="textField" message="#language.cityError#" /></td>
		</tr>
		<tr>
			<td id="province_header"><label for="province">Province:</label></td>
			<td headers="province_header"><cfinput name="province" value="#variables.province#" id="province" type="text" size="25" maxlength="40" required="no" CLASS="textField" message="#language.provinceError#" /></td>
		</tr>
		<tr>
			<td id="country_header"><label for="country">Country:</label></td>
			<td headers="country_header"><cfinput name="country" value="#variables.country#" id="country" type="text" size="25" maxlength="40" required="yes" CLASS="textField" message="#language.countryError#" /></td>
		</tr>
		<tr>
			<td id="zip_header"><label for="zip">Postal / Zip Code:</label></td>
			<td headers="zip_header"><cfinput name="zip" value="#variables.zip#" id="zip" type="text" size="12" maxlength="10" required="no" CLASS="textField" message="#language.zipError#" /></td>
		</tr>
		<tr>
			<td id="phone_header"><label for="phone">Phone:</label></td>
			<td headers="phone_header"><cfinput name="phone" value="#variables.phone#" id="phone" type="text" size="25" maxlength="32" required="yes" CLASS="textField" message="#language.phoneError#" /></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" align="center" style="padding-top:20px;">
				...
				<input type="button" name="cancel" value="Cancel" class="textbutton" onclick="self.location.href='addNewUserCompany.cfm?lang=#lang#$amp;info=#url.info#$amp;companies=#url.companies#'" />
			</td>
		</tr>
	</table>
</cfform>
