...
<cfset getUser.Email = DevEmail />
	...
	<cfmail to="#getUser.Email#" from="#AdministratorEmail#" subject="Company Request Approved - Demande de l'entreprise approuv&eacute;e" type="html" username="#mailuser#" password="#mailpassword#">
