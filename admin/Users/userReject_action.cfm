...
<cfset getUser.Email = DevEmail />
	...
	<cfmail to="#getUser.Email#" from="#AdministratorEmail#" subject="Company Request Rejected - Demande de l'entreprise rejet&eacute;e" type="html" username="#mailuser#" password="#mailpassword#">
