...
<cfset getDetails.Email = DevEmail />
	...
	<cfmail to="#getDetails.Email#" from="#AdministratorEmail#" subject="Booking Unconfirmed - R&eacute;servation non confirm&eacute;e" type="html" username="#mailuser#" password="#mailpassword#">
...
<cfif url.referrer NEQ "Edit Booking">
	...
	<cfset Session.Success.Message = "Booking status for <strong>#getDetails.vesselName#</strong> from #LSDateFormat(CreateODBCDate(getDetails.startDate), 'mmm d, yyyy')# to #LSDateFormat(CreateODBCDate(getDetails.endDate), 'mmm d, yyyy')# is now <strong>Pending</strong>.  Email notification of this change has been sent to the agent.">
