...
<cfset getBooking.Email = DevEmail />
		...
		<cfmail to="#getBooking.Email#" from="#AdministratorEmail#" subject="Booking Cancelled - R&eacute;servation annul&eacute;e: #getBooking.VesselName#" type="html" username="#mailuser#" password="#mailpassword#">
		<cfoutput>
