...
<cfif form.submitForm NEQ 'override'>
 	<cflocation url="addJettyBooking.cfm?lang=#lang#$amp;startdate=#DateFormat(url.startdate, 'mm/dd/yyyy')#$amp;enddate=#DateFormat(url.enddate, 'mm/dd/yyyy')#$amp;show=#url.show#" addToken="no">
</cfif>
</cfif>
...
<!-- End JavaScript Block -->
		...
		<cfinclude template="#RootDir#includes/left-menu-gauche-#lang#.cfm">
			...
			<div class="center">
				...
				<cfform action="addJettyBooking_action.cfm?startdate=#DateFormat(url.startdate, 'mm/dd/yyyy')#$amp;enddate=#DateFormat(url.enddate, 'mm/dd/yyyy')#$amp;show=#url.show#" method="post" enablecab="No" name="bookingreq" preservedata="Yes">
				...
				<table style="width:100%;" cellspacing="0" cellpadding="1" border="0" align="center">
					<tr>
						<td colspan="2" align="center">
							...
							<cfoutput><input type="button" value="Back" class="textbutton" onclick="self.location.href='addJettyBooking.cfm?lang=#lang#$amp;startdate=#DateFormat(url.startdate, 'mm/dd/yyyy')#$amp;enddate=#DateFormat(url.enddate, 'mm/dd/yyyy')#$amp;show=#url.show#'" />
